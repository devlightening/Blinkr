...
export const ONBOARDING_PAGES: OnboardingPage[] = [
  {
    id: 'know',
    title: tx('common:onboarding.p1title', 'Gitmeden önce bil'),
    body: tx('common:onboarding.p1body', 'Bir yerin şu an kalabalık mı, sıra var mı, açık mı olduğunu haritada canlı gör. Kararını buna göre ver.'),
  },
  {
    id: 'signal',
    title: tx('common:onboarding.p2title', 'Sen de bir sinyal bırak'),
    body: tx('common:onboarding.p2body', 'Bulunduğun yerde birkaç saniyede kısa bir sinyal paylaş. Sinyaller kısa ömürlüdür; eskiyen bilgi haritadan kalkar.'),
  },
  {
    id: 'privacy',
    title: tx('common:onboarding.p3title', 'Konumun sende kalır'),
    body: tx('common:onboarding.p3body', 'Kesin konumun kimseye gösterilmez. İstersen sinyalini anonim paylaşırsın; anonim sinyalleri yalnızca sen görürsün.'),
  },
];
