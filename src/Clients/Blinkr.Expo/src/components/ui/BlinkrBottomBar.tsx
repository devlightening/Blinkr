import { Camera, Map as MapIcon, MessageCircle, UserRound } from 'lucide-react-native';
...
export type BlinkrTab = 'chat' | 'map' | 'profile';
...
const tabLabels: Record<BlinkrTab, string> = { chat: 'Sohbet', map: 'Harita', profile: 'Profil' };
  ...
  return (
    ...
    >
      <View style={[styles.iconTile, active && styles.iconTileActive]}>
        <Icon color={color} size={26} strokeWidth={active ? 2.5 : 2.2} />
...
const styles = StyleSheet.create({
  ...
  iconTile: { alignItems: 'center', borderRadius: radii.md, height: 36, justifyContent: 'center', width: 52 },
