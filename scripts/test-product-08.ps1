...
try {
    ...
    foreach ($script in @('test-place-posting-real-catalog', 'test-nearby-distance-contract', 'test-nearby-place-ux-core', 'test-location-map-core', 'test-place-live-signal', 'test-content-media-smoke', 'test-auth-gateway-smoke', 'test-auth-registration', 'test-avatar', 'test-friends', 'test-safety', 'test-place-batch', 'test-place-search', 'test-chat-smoke', 'test-snap-smoke', 'test-author-posts-privacy', 'test-post-engagement', 'test-sensitive-place')) {
