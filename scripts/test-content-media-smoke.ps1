...
$catalog = Invoke-Json -Method GET -Url "$GatewayBaseUrl/api/places/nearby?lat=39.9334&lon=32.8597&radiusMeters=1500&limit=100"
$catalogPlace = $catalog.body | Where-Object externalProvider -eq 'osm' | Select-Object -First 1
if (-not $catalogPlace) { throw "Existing real OSM catalog is required." }
